 ...
 */
#ifdef EA_PLATFORM_C1 // ifdef for code stripping purposes 
...
#if defined(EA_PLATFORM_C1) || defined(_TARGET_C1) || defined(EA_PLATFORM_KETTLE)
...
#elif defined(EA_PLATFORM_C3) || defined(_TARGET_C3)
...
//
	...
	#elif defined(__e2k__) || defined(_WIN64) || defined(__LP64__) || defined(_LP64) || defined(_M_IA64) || defined(__ia64__) || defined(__arch64__) || defined(__aarch64__) || defined(__mips64__) || defined(__64BIT__) || defined(__Ptr_Is_64)
